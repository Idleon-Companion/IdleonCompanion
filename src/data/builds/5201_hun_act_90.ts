import { Class, Subclass } from "~/composables/Characters";
 ...
 export const build = {
  ...
  "notes": "**430 mana is required to sustain Piercing Arrow, Traps, and UWU Rawr, your main damaging talents.",
  "version": "1.21",
  "tabs": [
    {
      "skills": {
    ...
    },
    {
      ...
      "comment": "Level 40 \"Piercing Arrow\" to be able to hit 3 mobs, and 1 point into kick. Max \"High Polymer Limbs\" followed by 40 points into \"Have Another\" & 100 into \"Veins of the Infernal\". \n *1 = Excess points may be put into HP/MP, Smithing EXP, or more Agi."
    },
    {
      "skills": {
        "1": "1",
