  ...
  <div class="jumbotron pt-3">
    <div class="row">
      <div class="col">
        ...
        <hr />
        <p class="text-left">
          Many Thanks to <strong>Hateling#7191</strong> for the Toolbox, and
          <strong>abgreyd#0283</strong> for his original 101 builds. To
          <strong>Sillebuc#0036</strong> and <strong>Keloku#0956</strong> for
          their work on the builds.
        </p>
        <p class="text-left">
        ...
        <hr />
        <p class="text-info">
          Programming and Design by <strong>Musimaniac#7620</strong> For info or
          suggestions, write at
